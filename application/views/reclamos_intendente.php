...
<div class="col-sm-3">
    ...
    if(count($reclamos_list) > 0){
      ...
      <th>Código Reclamo</th><th>Fecha Alta</th><th>Localidad</th><th>Barrios</th><th>Calle</th><th>Nº</th><th>Título</th><th>Rta. hs</th><th>Estado</th><th>CAV</th><th>Obs.</th><th>Vecino</th> </tr>        </thead><tbody>';
