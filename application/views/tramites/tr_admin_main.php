          ...
          <div class="collapse navbar-collapse">
                ...
                <ul class="nav navbar-nav">
                  ...
                  <li class="tr_formularios">
                    <a href="<?php echo base_url(); ?>index.php/main_admin/formularios_admin_tramites"><i class="glyphicon glyphicon-th-list"></i>Formularios</a>
                  </li>
                  <li class="tr_tipo_tramite">
                    <a href="<?php echo base_url(); ?>index.php/main_admin/tipo_tramite_admin_tramites"><i class="glyphicon glyphicon-th-list"></i>Armar Tipo Tramite</a>
                  </li>                  
                  <li>
                    <a class="btn" href="<?php echo base_url() ?>index.php/login/logout_user"><i class="glyphicon glyphicon-share"></i>Logout</a>          
                  </li>
                  <li>
                    <a class="btn" href="<?php echo base_url() ?>"><i class="glyphicon glyphicon-share"></i>CAV Reclamos</a>          
                  </li>
                </ul>
          </div>
        </div>
