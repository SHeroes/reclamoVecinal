...
class Vecino_m extends CI_Model {
  ...
  function get_vecinos_by_DNI_equal($DNI){
    $where_str = 'domicilio.id_calle = calles.id_calle and  domiciliosxvecinos.id_domicilio = domicilio.id_domicilio and domiciliosxvecinos.id_vecino = vecino.id_vecino and DNI ='.$DNI;
