 ...
 $(document).ready(function(){
  ...
  if($(".vecinos_filtrados").length > 0){
    $(".vecinos_filtrados").click(function() {
        ...
        */
        stringUrl = '/index.php/edesur/Main_edesur_vecino/show_main?id_vecino='+value+'&name_vecino='+Apellido.html() + ", " + Nombre.html();
...
//      console.log("Avanzo uno");
  ...
  //          console.log(focusedElement);
      ...
      return false;
          ...
          $.ajax({
           type: "post",
           url: "/index.php/edesur/Main_edesur_vecino/search_calle",
           cache: false,    
           data: dataToSearch,
